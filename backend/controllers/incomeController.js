...
import { INCOME_CATEGORIES, PAYMENT_STATUSES } from "../constants/categories.js";
...
const resolveCategory = (category, customCategory) => {
...
export const addIncome = async (req, res) => {
  const { source, amount, category, customCategory, party, paymentMode, paymentStatus, dueDate, notes, date } =
    req.body;
