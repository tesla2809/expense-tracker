...
import { EXPENSE_CATEGORIES, PAYMENT_STATUSES } from "../constants/categories.js";
...
export const addExpense = async (req, res) => {
  const { title, amount, category, customCategory, party, paymentMode, paymentStatus, dueDate, notes, date } =
    req.body;
